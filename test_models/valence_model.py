...
class DebertaValenceSOTA(nn.Module):
    """
    Valence: CLS + mean pooling + simple arousal-like features.
    Head is MLP. Much lighter than GRU, typically strong for sentiment-like valence.
    """
    def __init__(self, base_model: str, vocab_size: int, hidden_dropout: float = 0.2, feat_dim: int = 4, freeze_layers: int = 0):
        super().__init__()
    ...
    def _freeze_bottom_layers(self, freeze_n: int):
        layer_paths = [
    ...
    def forward(self, input_ids=None, attention_mask=None, feats=None, labels=None, **kwargs):
        ...
        h = out.last_hidden_state  # (bs, seq, hidden)
...
def main():
    ...
    ap.add_argument("--label_col", default="valence")
    ap.add_argument("--base_model", default="microsoft/deberta-v3-base")
    ap.add_argument("--out_root", default="models/valence_sota_len128_cv")
    ...
    ap.add_argument("--freeze_layers", type=int, default=0, help="0 = no freeze; try 4-8 if OOM on MPS")
