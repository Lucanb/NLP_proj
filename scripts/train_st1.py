...
def main():
    ...
    # --- IMPORTARE DINAMICA EVALUATOR OFICIAL ---
    ...
    try:
        ...
        print(f"✅ Evaluator oficial incarcat din: {args.eval_repo}")
    except ImportError as e:
        print(f"Eroare critica: Nu pot importa 'eval.py'. Verifică calea. ({e})")
        sys.exit(1)
    ...
    print("\n📊 Generare predictii pe setul de validare...")
    ...
    try:
        ...
        print(f"Eroare la rularea scriptului oficial: {e}")
